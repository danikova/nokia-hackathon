  ...
  return (
    ...
    >
      <IconButton
        ...
        className={cn(
          props.isBold && "bg-muted-foreground text-primary-foreground"
        )}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(
          props.isItalic && "bg-muted-foreground text-primary-foreground"
        )}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(
          props.isUnderline && "bg-muted-foreground text-primary-foreground"
        )}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(
          props.isStrikethrough && "bg-muted-foreground text-primary-foreground"
        )}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(
          props.isCode && "bg-muted-foreground text-primary-foreground"
        )}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(
          props.isLink && "bg-muted-foreground text-primary-foreground"
        )}
        onClick={() => {
