...
func init() {
	m.Register(func(db dbx.Builder) error {
		...
		// remove
		collection.Schema.RemoveField("7zeuyert")

		// remove
		collection.Schema.RemoveField("mthd24kj")

		// remove
		collection.Schema.RemoveField("vaofnt4f")

		// remove
		collection.Schema.RemoveField("cq1hdjzw")
