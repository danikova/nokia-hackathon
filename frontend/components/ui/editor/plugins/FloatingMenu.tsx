...
function FloatingMenu({ show, ...props }: FloatingMenuProps) {
  ...
  return (
    <div
      ...
      className={`z-[100] absolute flex items-center justify-between bg-slate-100 border-[1px] border-slate-300 rounded-md p-1 gap-1 ${pos?.x && pos.y ? "opacity-1 visible" : "opacity-0 invisible"}`}
    >
      <IconButton
        icon="bold"
        aria-label="Format text as bold"
        className={cn(props.isBold && 'bg-muted-foreground text-primary-foreground')}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(props.isItalic && 'bg-muted-foreground text-primary-foreground')}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(props.isUnderline && 'bg-muted-foreground text-primary-foreground')}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(props.isStrikethrough && 'bg-muted-foreground text-primary-foreground')}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(props.isCode && 'bg-muted-foreground text-primary-foreground')}
        onClick={() => {
      ...
      <IconButton
        ...
        className={cn(props.isLink && 'bg-muted-foreground text-primary-foreground')}
        onClick={() => {
